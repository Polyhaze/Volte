...
namespace Volte.Commands.Modules
{
    public sealed partial class AdminUtilityModule
    {
        ...
        public async Task<ActionResult> ChannelNameAsync([Remainder, Description("The name to change the channel to. Automatically replaces spaces with -.")] string name)
        {
