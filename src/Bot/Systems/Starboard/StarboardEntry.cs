...
public class StarboardDbEntry
{
    ...
    [JsonPropertyName("key")] public ulong Key { get; set; }

    [JsonPropertyName("value")] public StarboardEntry Value { get; set; }
}
...
public class StarboardEntry
{
    ...
    [JsonPropertyName("stargazers")] public Dictionary<ulong, StarTarget> Stargazers { get; set; }

    [JsonIgnore] public int StarCount => Stargazers.Count;
}
