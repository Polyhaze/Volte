...
public sealed partial class ModerationModule
{
        ...
        SocketGuildUser member)
    {
        ...
        return Ok($"Cleared **{warnCount}** {"warning".ToQuantity(warnCount, showQuantityAs: ShowQuantityAs.None)} for **{member}**.", 
            Context.ModAction(ModActionType.ClearWarns).WithTarget(member)
        );
    }
}